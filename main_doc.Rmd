  ...
  #   shape (n_h, 1)
{
  ...
  indices = seq(1, n_h)
  # create a counter to count the number of times a index is selected, 
  # shape is (n_h, 1)
  counter = rep(0, n_h)
  ...
  for (s in 1:k_h)
  {
    ...
    {
      # log the number of appearances of index of elements in stratum h 
      counter[index] = counter[index] + 1
    }
  }
  # calculate the bootstrap weights using stra_weights and counter 
